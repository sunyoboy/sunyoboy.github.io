              ...
              items: [
                {
                  ...
                  collapsed: false,
                  items: [
                    { text: '09-11 · 放量普跌·美债5.35%新高·有色资源杀跌', link: '/review/2026/09/2026-09-11' },
              ...
              items: [
                {
                  ...
                  collapsed: false,
                  items: [
                    { text: '08-31 · 低开高走V型反转·科技反攻·8月收官月线收涨', link: '/review/2026/08/2026-08-31' },
                    ...
                    { text: '08-25 · 缩量分化·消费医药领涨·有色资源承压', link: '/review/2026/08/2026-08-25' },
                    ...
                    { text: '08-05 · 修复加速·科创50+4.78%·资源爆发', link: '/review/2026/08/2026-08-05' },
          ...
          items: [
            ...
            { text: '🗺️ 网站全景图', link: '/docs/knowledge-tree' },
            {
              ...
              items: [
                ...
                { text: '🔧 项目技术栈', link: '/docs/tech-stack' },
